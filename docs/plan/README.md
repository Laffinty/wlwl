...
2026-09-23 v0.8.0 归档后,v0.7 及更早材料在 `docs/history/`:
...
| 偏差登记 v0.8 分册 | `../history/deviations-v0.8.md` |
| 既有日次 / 阶段史 | `../history/2026*.md`、`p3-011-spec-alignment.md` |
| 早期计划 | `../history/wlwl-build-plan-v0.1-COMPLETED.md`、`wlwl-build-plan-v0.2.md` |

**现行规范**:`../standard/wlwl-spec-v0.8.md`。新一轮迭代请在本目录新建
`wlwl-build-plan-v0.9.md` 与空白 `deviations.md`。
