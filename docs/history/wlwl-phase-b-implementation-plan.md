...
> Phase B 子计划(WIP 文档)。原路径 `docs/plan/wlwl-phase-b-implementation-plan.md`。
> 所属总计划:[`wlwl-build-plan-v0.7-COMPLETED.md`](wlwl-build-plan-v0.7-COMPLETED.md)。
> 内文出现的 `docs/plan/…` 为写作当时的路径,未改写(历史记录)。
