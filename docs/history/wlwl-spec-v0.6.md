> **ARCHIVE NOTE (2026-09-22 · Phase H1 归档)**
> 本文档是 **wlwl-spec-v0.6** 的完整快照,原路径 `docs/standard/wlwl-spec-v0.6.md`。
> **现行规范**为 [`docs/standard/wlwl-spec-v0.7.md`](../standard/wlwl-spec-v0.7.md)(在 v0.6 上只追加)。
> §0–§12 及附录 A–C 语义未被 v0.7 改写;追溯以本文件为准。
