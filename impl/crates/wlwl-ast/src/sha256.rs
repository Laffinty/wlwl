...
//!
//! Phase E3 (spec v0.4 §16.4.1) needs a content hash for AST nodes.
//! The workspace deliberately carries no external crypto dependency,
//! so the hash is implemented here (~100 lines, no allocation beyond
//! the output buffer). It is used only for change detection, not for
