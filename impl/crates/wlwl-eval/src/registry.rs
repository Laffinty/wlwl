...
pub const BUILTIN_REGISTRY: &[BuiltinSpec] = &[
    ...
    BuiltinSpec { name: "KEYS",       signature: "KEYS(dict) -> ARRAY",                          group: BuiltinGroup::Dict,     err_consumer: ErrConsumerStatus::No,  macro_fn: false, version: Version::V02, dispatch: DispatchStatus::ResolvedBuiltin,   section: "§10.2" },
    BuiltinSpec { name: "VALUES",     signature: "VALUES(dict) -> ARRAY",                        group: BuiltinGroup::Dict,     err_consumer: ErrConsumerStatus::No,  macro_fn: false, version: Version::V02, dispatch: DispatchStatus::ResolvedBuiltin,   section: "§10.2" },
    BuiltinSpec { name: "HAS",        signature: "HAS(dict, k) -> BOOLEAN",                      group: BuiltinGroup::Dict,     err_consumer: ErrConsumerStatus::No,  macro_fn: false, version: Version::V02, dispatch: DispatchStatus::ResolvedBuiltin,   section: "§10.2" },
    BuiltinSpec { name: "MERGE",      signature: "MERGE(a, b) -> DICT",                          group: BuiltinGroup::Dict,     err_consumer: ErrConsumerStatus::No,  macro_fn: false, version: Version::V02, dispatch: DispatchStatus::ResolvedBuiltin,   section: "§10.2" },
