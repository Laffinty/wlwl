...
pub const BUILTIN_REGISTRY: &[BuiltinSpec] = &[
    ...
    BuiltinSpec { name: "SHIFT",      signature: "SHIFT(arr) -> ARRAY",                          group: BuiltinGroup::Array,    err_consumer: ErrConsumerStatus::No,  macro_fn: false, version: Version::V02, dispatch: DispatchStatus::Deferred,         section: "§10.1" },
    BuiltinSpec { name: "UNSHIFT",    signature: "UNSHIFT(arr, x) -> ARRAY",                     group: BuiltinGroup::Array,    err_consumer: ErrConsumerStatus::No,  macro_fn: false, version: Version::V02, dispatch: DispatchStatus::Deferred,         section: "§10.1" },
    BuiltinSpec { name: "SLICE",      signature: "SLICE(arr, start, end?) -> ARRAY",             group: BuiltinGroup::Array,    err_consumer: ErrConsumerStatus::No,  macro_fn: false, version: Version::V02, dispatch: DispatchStatus::Deferred,         section: "§10.1" },
    BuiltinSpec { name: "CONCAT",     signature: "CONCAT(a, b) -> ARRAY",                       group: BuiltinGroup::Array,    err_consumer: ErrConsumerStatus::No,  macro_fn: false, version: Version::V02, dispatch: DispatchStatus::Deferred,         section: "§10.1" },
    BuiltinSpec { name: "CONTAINS",   signature: "CONTAINS(arr, x) -> BOOLEAN",                  group: BuiltinGroup::Array,    err_consumer: ErrConsumerStatus::No,  macro_fn: false, version: Version::V02, dispatch: DispatchStatus::Deferred,         section: "§10.1" },
    BuiltinSpec { name: "INDEX",      signature: "INDEX(arr, x) -> INTEGER / E0031",             group: BuiltinGroup::Array,    err_consumer: ErrConsumerStatus::No,  macro_fn: false, version: Version::V02, dispatch: DispatchStatus::Deferred,         section: "§10.1" },
    BuiltinSpec { name: "REVERSE",    signature: "REVERSE(arr) -> ARRAY",                        group: BuiltinGroup::Array,    err_consumer: ErrConsumerStatus::No,  macro_fn: false, version: Version::V02, dispatch: DispatchStatus::Deferred,         section: "§10.1" },
    ...
    // ── STRING 操作 (15) ────────────────────────────────────────
    BuiltinSpec { name: "UPPER",          signature: "UPPER(s) -> STRING",                       group: BuiltinGroup::String, err_consumer: ErrConsumerStatus::No,  macro_fn: false, version: Version::V02, dispatch: DispatchStatus::Deferred,         section: "§10.3" },
    BuiltinSpec { name: "LOWER",          signature: "LOWER(s) -> STRING",                       group: BuiltinGroup::String, err_consumer: ErrConsumerStatus::No,  macro_fn: false, version: Version::V02, dispatch: DispatchStatus::Deferred,         section: "§10.3" },
    BuiltinSpec { name: "SUB",            signature: "SUB(s, start, end?) -> STRING",            group: BuiltinGroup::String, err_consumer: ErrConsumerStatus::No,  macro_fn: false, version: Version::V02, dispatch: DispatchStatus::Deferred,         section: "§10.3" },
    BuiltinSpec { name: "REPLACE",        signature: "REPLACE(s, old, new) -> STRING",           group: BuiltinGroup::String, err_consumer: ErrConsumerStatus::No,  macro_fn: false, version: Version::V02, dispatch: DispatchStatus::Deferred,         section: "§10.3" },
    BuiltinSpec { name: "SPLIT",          signature: "SPLIT(s, sep) -> ARRAY",                    group: BuiltinGroup::String, err_consumer: ErrConsumerStatus::No,  macro_fn: false, version: Version::V02, dispatch: DispatchStatus::Deferred,         section: "§10.3" },
